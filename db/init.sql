...
CREATE TABLE IF NOT EXISTS tblOscarFemale (
    `fldIndex` INT,
    `fldYear` INT,
    `fldAge` INT,
    `fldName` VARCHAR(255) CHARACTER SET utf8,
    `fldMovie` VARCHAR(255) CHARACTER SET utf8,
    PRIMARY KEY (`fldIndex`)
);

INSERT INTO tblOscarFemale VALUES
